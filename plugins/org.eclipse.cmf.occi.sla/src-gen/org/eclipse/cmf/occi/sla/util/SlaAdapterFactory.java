...
public class SlaAdapterFactory extends AdapterFactoryImpl {
	...
	protected SlaSwitch<Adapter> modelSwitch =
		new SlaSwitch<Adapter>() {
			...
			@Override
			public Adapter caseAgreement_link(Agreement_link object) {
				return createAgreement_linkAdapter();
			}
			@Override
			public Adapter caseAgreement_tpl(Agreement_tpl object) {
				return createAgreement_tplAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.cmf.occi.sla.Agreement <em>Agreement</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.cmf.occi.sla.Agreement_link <em>Agreement link</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.cmf.occi.sla.Agreement_tpl <em>Agreement tpl</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
