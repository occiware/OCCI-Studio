...
public class SlaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SlaPackage.AGREEMENT: {
				...
				if (result == null) result = caseResource(agreement);
				if (result == null) result = caseEntity(agreement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlaPackage.AGREEMENT_LINK: {
				Agreement_link agreement_link = (Agreement_link)theEObject;
				T result = caseAgreement_link(agreement_link);
				if (result == null) result = caseLink(agreement_link);
				if (result == null) result = caseEntity(agreement_link);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlaPackage.AGREEMENT_TPL: {
				Agreement_tpl agreement_tpl = (Agreement_tpl)theEObject;
				T result = caseAgreement_tpl(agreement_tpl);
				if (result == null) result = caseMixinBase(agreement_tpl);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlaPackage.AGREEMENT_TERM: {
				Agreement_term agreement_term = (Agreement_term)theEObject;
				T result = caseAgreement_term(agreement_term);
				if (result == null) result = caseMixinBase(agreement_term);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseAgreement_link(Agreement_link object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Agreement tpl</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Agreement tpl</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAgreement_tpl(Agreement_tpl object) {
		return null;
	}
