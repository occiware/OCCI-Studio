...
*******************************************************************************/
package org.eclipse.cmf.examples.utils;
 ...
 */
//This code comes from org.eclipse.compare.internal
public class ImageCanvas extends Canvas {

	private Image fImage;

	/*
	 * Create a new ImageCanvas with the given SWT stylebits. (SWT.H_SCROLL and
	 * SWT.V_SCROLL are automtically added).
	 */
	...
	void updateScrollbars() {
		Rectangle bounds = fImage != null ? fImage.getBounds() : new Rectangle(
				0, 0, 0, 0);
		Point size = getSize();
		Rectangle clientArea = getClientArea();
