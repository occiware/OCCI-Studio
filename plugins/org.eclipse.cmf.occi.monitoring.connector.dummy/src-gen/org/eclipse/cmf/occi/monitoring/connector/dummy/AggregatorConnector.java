 ...
 */
public class AggregatorConnector extends org.eclipse.cmf.occi.monitoring.impl.AggregatorImpl
{
	/**
	 * Initialize the logger.
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(AggregatorConnector.class);

	// Start of user code Aggregatorconnector_constructor
	/**
	 * Constructs a aggregator connector.
	 */
	AggregatorConnector()
	{
