...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.crtp.Medium} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MediumItemProvider extends MixinBaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Medium_occiComputeCores_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Medium_occiComputeCores_feature", "_UI_Medium_type"),
				 CrtpPackage.Literals.MEDIUM__OCCI_COMPUTE_CORES,
				 true,
				 false,
				 false,
	...
	protected void addOcciComputeMemoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Medium_occiComputeMemory_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Medium_occiComputeMemory_feature", "_UI_Medium_type"),
				 CrtpPackage.Literals.MEDIUM__OCCI_COMPUTE_MEMORY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOcciComputeEphemeralStorageSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Medium_occiComputeEphemeralStorageSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Medium_occiComputeEphemeralStorageSize_feature", "_UI_Medium_type"),
				 CrtpPackage.Literals.MEDIUM__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Integer labelValue = ((Medium)object).getOcciComputeCores();
