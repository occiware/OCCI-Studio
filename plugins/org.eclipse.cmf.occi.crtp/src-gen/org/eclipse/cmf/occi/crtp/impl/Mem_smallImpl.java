...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Mem small</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.crtp.impl.Mem_smallImpl#getOcciComputeCores <em>Occi Compute Cores</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.crtp.impl.Mem_smallImpl#getOcciComputeMemory <em>Occi Compute Memory</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.crtp.impl.Mem_smallImpl#getOcciComputeEphemeralStorageSize <em>Occi Compute Ephemeral Storage Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Mem_smallImpl extends MixinBaseImpl implements Mem_small {
	/**
	...
	protected EClass eStaticClass() {
		return CrtpPackage.Literals.MEM_SMALL;
	}
	...
	public void setOcciComputeCores(Integer newOcciComputeCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CrtpPackage.MEM_SMALL__OCCI_COMPUTE_CORES, oldOcciComputeCores, occiComputeCores));
	}
	...
	public void setOcciComputeMemory(Float newOcciComputeMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CrtpPackage.MEM_SMALL__OCCI_COMPUTE_MEMORY, oldOcciComputeMemory, occiComputeMemory));
	}
	...
	public void setOcciComputeEphemeralStorageSize(Float newOcciComputeEphemeralStorageSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CrtpPackage.MEM_SMALL__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE, oldOcciComputeEphemeralStorageSize, occiComputeEphemeralStorageSize));
	}
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, CrtpTables.STR_Mem_small_c_c_appliesConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, CrtpTables.STR_Mem_small_c_c_appliesConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, CrtpTables.INT_0).booleanValue();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CrtpPackage.MEM_SMALL__OCCI_COMPUTE_CORES:
				return getOcciComputeCores();
			case CrtpPackage.MEM_SMALL__OCCI_COMPUTE_MEMORY:
				return getOcciComputeMemory();
			case CrtpPackage.MEM_SMALL__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CrtpPackage.MEM_SMALL___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
