 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.crtp.impl.MediumImpl#getOcciComputeCores <em>Occi Compute Cores</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.crtp.impl.MediumImpl#getOcciComputeMemory <em>Occi Compute Memory</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.crtp.impl.MediumImpl#getOcciComputeEphemeralStorageSize <em>Occi Compute Ephemeral Storage Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MediumImpl extends MixinBaseImpl implements Medium {
	/**
	 ...
	 * @ordered
	 */
	protected static final Float OCCI_COMPUTE_MEMORY_EDEFAULT = new Float(2.0F);
	...
	protected EClass eStaticClass() {
		return CrtpPackage.Literals.MEDIUM;
	}
	...
	public void setOcciComputeCores(Integer newOcciComputeCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CrtpPackage.MEDIUM__OCCI_COMPUTE_CORES, oldOcciComputeCores, occiComputeCores));
	}
	...
	public void setOcciComputeMemory(Float newOcciComputeMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CrtpPackage.MEDIUM__OCCI_COMPUTE_MEMORY, oldOcciComputeMemory, occiComputeMemory));
	}
	...
	public void setOcciComputeEphemeralStorageSize(Float newOcciComputeEphemeralStorageSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CrtpPackage.MEDIUM__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE, oldOcciComputeEphemeralStorageSize, occiComputeEphemeralStorageSize));
	}
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, CrtpTables.STR_Medium_c_c_appliesConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, CrtpTables.STR_Medium_c_c_appliesConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, CrtpTables.INT_0).booleanValue();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CrtpPackage.MEDIUM__OCCI_COMPUTE_CORES:
				return getOcciComputeCores();
			case CrtpPackage.MEDIUM__OCCI_COMPUTE_MEMORY:
				return getOcciComputeMemory();
			case CrtpPackage.MEDIUM__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CrtpPackage.MEDIUM___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
