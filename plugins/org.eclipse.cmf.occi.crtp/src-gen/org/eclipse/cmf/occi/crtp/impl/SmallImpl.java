 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.crtp.impl.SmallImpl#getOcciComputeCores <em>Occi Compute Cores</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.crtp.impl.SmallImpl#getOcciComputeMemory <em>Occi Compute Memory</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.crtp.impl.SmallImpl#getOcciComputeEphemeralStorageSize <em>Occi Compute Ephemeral Storage Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SmallImpl extends MixinBaseImpl implements Small {
	/**
	 ...
	 * @ordered
	 */
	protected static final Float OCCI_COMPUTE_MEMORY_EDEFAULT = new Float(1.0F);
	 ...
	 * @ordered
	 */
	protected static final Float OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE_EDEFAULT = new Float(10.0F);
	...
	protected EClass eStaticClass() {
		return CrtpPackage.Literals.SMALL;
	}
	...
	public void setOcciComputeCores(Integer newOcciComputeCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CrtpPackage.SMALL__OCCI_COMPUTE_CORES, oldOcciComputeCores, occiComputeCores));
	}
	...
	public void setOcciComputeMemory(Float newOcciComputeMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CrtpPackage.SMALL__OCCI_COMPUTE_MEMORY, oldOcciComputeMemory, occiComputeMemory));
	}
	...
	public void setOcciComputeEphemeralStorageSize(Float newOcciComputeEphemeralStorageSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CrtpPackage.SMALL__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE, oldOcciComputeEphemeralStorageSize, occiComputeEphemeralStorageSize));
	}
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, CrtpTables.STR_Small_c_c_appliesConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_infrastructure_c_c_Compute = idResolver.getClass(CrtpTables.CLSSid_Compute, null);
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, CrtpTables.STR_Small_c_c_appliesConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, CrtpTables.INT_0).booleanValue();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CrtpPackage.SMALL__OCCI_COMPUTE_CORES:
				return getOcciComputeCores();
			case CrtpPackage.SMALL__OCCI_COMPUTE_MEMORY:
				return getOcciComputeMemory();
			case CrtpPackage.SMALL__OCCI_COMPUTE_EPHEMERAL_STORAGE_SIZE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CrtpPackage.SMALL___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
