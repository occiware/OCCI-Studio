...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.infrastructure.User_data} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class User_dataItemProvider extends MixinBaseItemProvider {
	/**
	 ...
	 * @generated
	 */
	public User_dataItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/User_data"));
	}
	...
	public String getText(Object object) {
		String label = ((User_data)object).getOcciComputeUserdata();
		return label == null || label.length() == 0 ?
			getString("_UI_User_data_type") :
			getString("_UI_User_data_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(User_data.class)) {
