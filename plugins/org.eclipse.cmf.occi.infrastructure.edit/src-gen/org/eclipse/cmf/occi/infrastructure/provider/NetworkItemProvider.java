...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.infrastructure.Network} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkItemProvider extends ResourceItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOcciNetworkVlanPropertyDescriptor(object);
			addOcciNetworkLabelPropertyDescriptor(object);
			addOcciNetworkStatePropertyDescriptor(object);
			addOcciNetworkStateMessagePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Occi Network Label feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOcciNetworkLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_occiNetworkLabel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_occiNetworkLabel_feature", "_UI_Network_type"),
				 InfrastructurePackage.Literals.NETWORK__OCCI_NETWORK_LABEL,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Occi Network State Message feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOcciNetworkStateMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_occiNetworkStateMessage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_occiNetworkStateMessage_feature", "_UI_Network_type"),
				 InfrastructurePackage.Literals.NETWORK__OCCI_NETWORK_STATE_MESSAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
