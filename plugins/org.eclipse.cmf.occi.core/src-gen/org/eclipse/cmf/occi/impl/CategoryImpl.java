 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.cmf.occi.impl.CategoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.impl.CategoryImpl#getTerm <em>Term</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.impl.CategoryImpl#getScheme <em>Scheme</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.impl.CategoryImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.eclipse.cmf.occi.impl.CategoryImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CategoryImpl extends MinimalEObjectImpl.Container implements Category {
	...
	public boolean AttributesNameUnique(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, OCCITables.STR_Category_c_c_AttributesNameUnique, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_result, OCCITables.INT_0).booleanValue();
	...
	public boolean IdentityUnique(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		if (le) {
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, OCCITables.STR_Category_c_c_IdentityUnique, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_result, OCCITables.INT_0).booleanValue();
			symbol_0 = logDiagnostic;
		}
		return Boolean.TRUE == symbol_0;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case OCCIPackage.CATEGORY___ATTRIBUTES_NAME_UNIQUE__DIAGNOSTICCHAIN_MAP_1:
				return AttributesNameUnique((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case OCCIPackage.CATEGORY___IDENTITY_UNIQUE__DIAGNOSTICCHAIN_MAP_1:
				return IdentityUnique((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case OCCIPackage.CATEGORY___SCHEME_ENDS_WITH_SHARP__DIAGNOSTICCHAIN_MAP_1:
