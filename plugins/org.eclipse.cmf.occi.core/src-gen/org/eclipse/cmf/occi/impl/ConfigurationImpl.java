...
public class ConfigurationImpl extends MinimalEObjectImpl.Container implements Configuration {
	...
	public boolean AllResourcesLinksMixinsInUse(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		 ...
		 *     else
		 *       let
		 *         status : OclAny[?] = resources.links.parts.mixin->forAll(mo |
		...
		if (le) {
		    ...
		    try {
		        ...
		        while (true) {
		             ...
		             * parts
		             */
		            final /*@Thrown*/ List<MixinBase> parts = _1_0.getParts();
		        ...
		        while (true) {
		             ...
		             * mixin
		             */
		            final /*@Thrown*/ Mixin mixin = _1_1.getMixin();
		            //
		        ...
		        while (true) {
		            ...
		            try {
		                ...
		                if (oclIsTypeOf) {
		                    ...
		                    final /*@Thrown*/ List<Mixin> mixins = this.getMixins();
		                    final /*@Thrown*/ OrderedSetValue BOXED_mixins = idResolver.createOrderedSetOfAll(OCCITables.ORD_CLSSid_Mixin, mixins);
		                    final /*@Thrown*/ boolean includes_0 = CollectionIncludesOperation.INSTANCE.evaluate(BOXED_mixins, mo).booleanValue();
		                    symbol_0 = includes_0;
		                }
	...
	public boolean AllResourcesMixinsInUse(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		 ...
		 *     else
		 *       let
		 *         status : OclAny[?] = resources.parts.mixin->forAll(mo |
		 *           let mixinOwner : OclElement[?] = mo.oclContainer()
		 *           in
		 *             if mixinOwner.oclIsTypeOf(Extension)
		 *             then
		...
		if (le) {
		    ...
		    try {
		        ...
		        while (true) {
		             ...
		             * parts
		             */
		            final /*@Thrown*/ List<MixinBase> parts = _1.getParts();
		            final /*@Thrown*/ OrderedSetValue BOXED_parts = idResolver.createOrderedSetOfAll(OCCITables.ORD_CLSSid_MixinBase, parts);
		            //
		            for (Object value : BOXED_parts.flatten().getElements()) {
		                accumulator.add(value);
		        ...
		        while (true) {
		             ...
		             * mixin
		             */
		            final /*@Thrown*/ Mixin mixin = _1_0.getMixin();
		            //
