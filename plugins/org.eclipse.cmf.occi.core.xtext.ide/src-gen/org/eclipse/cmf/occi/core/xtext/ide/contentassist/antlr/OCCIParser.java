		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRecordTypeAccess().getRecordFieldsAssignment_3(), "rule__RecordType__RecordFieldsAssignment_3");
					put(grammarAccess.getRecordTypeAccess().getRecordFieldsAssignment_4_1(), "rule__RecordType__RecordFieldsAssignment_4_1");
					put(grammarAccess.getRecordTypeAccess().getDocumentationAssignment_6_1(), "rule__RecordType__DocumentationAssignment_6_1");
