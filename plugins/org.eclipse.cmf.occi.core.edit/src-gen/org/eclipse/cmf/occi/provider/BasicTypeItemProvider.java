...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.core.BasicType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BasicTypeItemProvider extends DataTypeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OCCIPackage.Literals.BASIC_TYPE__ANNOTATIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BasicType.class)) {
			case OCCIPackage.BASIC_TYPE__ANNOTATIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OCCIPackage.Literals.BASIC_TYPE__ANNOTATIONS,
				 OCCIFactory.eINSTANCE.createTypeAnnotation()));
	}
