 ...
 * @generated
 */
public class RecordTypeItemProvider extends ItemProviderAdapter {
	/**
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RecordType.class)) {
			case OcciPackage.RECORD_TYPE__NAME:
			case OcciPackage.RECORD_TYPE__INSTANCE_CLASS_NAME:
			case OcciPackage.RECORD_TYPE__INSTANCE_CLASS:
			case OcciPackage.RECORD_TYPE__DEFAULT_VALUE:
			case OcciPackage.RECORD_TYPE__INSTANCE_TYPE_NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case OcciPackage.RECORD_TYPE__EANNOTATIONS:
			case OcciPackage.RECORD_TYPE__ETYPE_PARAMETERS:
