...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.core.AnnotatedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotatedElementItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OCCIPackage.Literals.ANNOTATED_ELEMENT__ANNOTATIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AnnotatedElement.class)) {
			case OCCIPackage.ANNOTATED_ELEMENT__ANNOTATIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OCCIPackage.Literals.ANNOTATED_ELEMENT__ANNOTATIONS,
				 OCCIFactory.eINSTANCE.createAnnotation()));
	}
