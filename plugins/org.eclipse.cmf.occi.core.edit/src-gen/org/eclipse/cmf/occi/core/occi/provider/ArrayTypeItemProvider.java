...
/**
 * This is the item provider adapter for a {@link org.eclipse.cmf.occi.core.occi.ArrayType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayTypeItemProvider extends ItemProviderAdapter {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArrayType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArrayType_type_feature", "_UI_ArrayType_type"),
				 OcciPackage.Literals.ARRAY_TYPE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ArrayType.class)) {
			case OcciPackage.ARRAY_TYPE__NAME:
			case OcciPackage.ARRAY_TYPE__INSTANCE_CLASS_NAME:
			case OcciPackage.ARRAY_TYPE__INSTANCE_CLASS:
			case OcciPackage.ARRAY_TYPE__DEFAULT_VALUE:
			case OcciPackage.ARRAY_TYPE__INSTANCE_TYPE_NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case OcciPackage.ARRAY_TYPE__EANNOTATIONS:
			case OcciPackage.ARRAY_TYPE__ETYPE_PARAMETERS:
