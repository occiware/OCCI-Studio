...
public class MetricImpl extends MixinBaseImpl implements Metric {
	...
	protected EClass eStaticClass() {
		return MonitoringPackage.Literals.METRIC;
	}
	...
	public boolean appliesConstraint(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, MonitoringTables.STR_Metric_c_c_appliesConstraint);
		...
		if (le) {
			...
			final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_monitoring_c_c_Collector = idResolver.getClass(MonitoringTables.CLSSid_Collector, null);
			...
			final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, MonitoringTables.STR_Metric_c_c_appliesConstraint, this, (Object)null, diagnostics, context, (Object)null, severity_0, result, MonitoringTables.INT_0).booleanValue();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MonitoringPackage.METRIC___APPLIES_CONSTRAINT__DIAGNOSTICCHAIN_MAP:
