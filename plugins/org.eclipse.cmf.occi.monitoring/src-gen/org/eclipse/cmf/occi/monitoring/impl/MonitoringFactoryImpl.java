...
public class MonitoringFactoryImpl extends EFactoryImpl implements MonitoringFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case MonitoringPackage.COLLECTOR: return createCollector();
			case MonitoringPackage.METRIC: return createMetric();
			case MonitoringPackage.AGGREGATOR: return createAggregator();
	 ...
	 * @generated
	 */
	public Integer createSecondFromString(EDataType eDataType, String initialValue) {
