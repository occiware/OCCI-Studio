	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MonitoringPackage.SENSOR: {
				...
				if (result == null) result = caseResource(sensor);
			...
			case MonitoringPackage.COLLECTOR: {
				...
				if (result == null) result = caseLink(collector);
				if (result == null) result = caseEntity(collector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case MonitoringPackage.AGGREGATOR: {
				...
				if (result == null) result = caseMixinBase(aggregator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MonitoringPackage.PUBLISHER: {
				...
				if (result == null) result = caseMixinBase(publisher);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
